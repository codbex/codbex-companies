...
const validationModules = await Extensions.loadExtensionModules("codbex-companies-Companies-JobRole", ["validate"]);
...
class JobRoleService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-companies/gen/codbex-companies/api/Companies/JobRoleService.ts/" + entity.Id);
